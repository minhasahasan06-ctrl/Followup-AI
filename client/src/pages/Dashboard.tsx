            ...
            <CardContent>
              <Tabs defaultValue="device" className="space-y-4">
                ...
                <TabsContent value="camera" className="space-y-4">
                  {latestVideoMetrics ? (
                    <>
                      {/* Latest ML Analysis Results */}
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium">Latest AI Analysis</p>
                          <Link href="/guided-video-exam">
                            <Button size="sm" variant="outline" className="gap-2" data-testid="button-new-exam">
                        ...
                        {/* Quality Metrics - Complete ML Integration */}
                    ...
                    <>
                      {/* No data yet - Show examination info */}
                      <div className="rounded-lg border bg-gradient-to-br from-primary/5 to-primary/10 p-4 space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">7-stage comprehensive guided assessment</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5 text-xs">
                          ...
                          <div className="flex items-center gap-1.5">
                            <Eye className="h-3 w-3 text-yellow-500" />
                            <span className="text-muted-foreground">Eye Sclera</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <Users className="h-3 w-3 text-rose-500" />
                            <span className="text-muted-foreground">Facial Swelling</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <Zap className="h-3 w-3 text-purple-500" />
                            <span className="text-muted-foreground">Tremor Detection</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <Smile className="h-3 w-3 text-pink-500" />
                            <span className="text-muted-foreground">Tongue Analysis</span>
                          </div>
                          <div className="flex items-center gap-1.5 col-span-2">
                            <Activity className="h-3 w-3 text-teal-500" />
                            <span className="text-muted-foreground">Custom Examination (Optional)</span>
                          </div>
                        </div>
                        ...
                        <p className="text-xs text-center text-muted-foreground">
                          Camera access required • ~5-7 minutes • HIPAA-compliant
                        </p>
                      </div>
                      
                      <div className="text-xs text-muted-foreground" data-testid="text-video-info">
                        <p className="font-medium mb-1">AI analyzes:</p>
                        <ul className="space-y-0.5 ml-4 list-disc">
                          <li>Respiratory rate & breathing patterns</li>
                          <li>Skin pallor & color changes (anemia)</li>
                          <li>Sclera yellowness (jaundice)</li>
