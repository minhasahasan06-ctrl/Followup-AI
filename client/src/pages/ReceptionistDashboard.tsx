...
import { Calendar, Clock, Mail, Phone, Plus, User, Video } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-semibold mb-2" data-testid="text-receptionist-title">
            Assistant Lysa Receptionist
          </h1>
          <p className="text-muted-foreground">
            Manage appointments, emails, and phone calls in one place
          </p>
        </div>
